...
export class EstadoCrearComponent implements OnInit {
  ...
  crearNuevaActividad(iniciarTiempo:boolean) {
    ...
    this.nuevaActividad_envio.colaborador = this.colaboradoresAsignados.value;
    ...
    this.nuevaActividad_envio.ordenPersonalizado = null;
    this.nuevaActividad_envio.principal = true;
    ...
    if (iniciarTiempo) {
      this.nuevaActividad_envio.tiempoInicio = Date.now();  
    }
