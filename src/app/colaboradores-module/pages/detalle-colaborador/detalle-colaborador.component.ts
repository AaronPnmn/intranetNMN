...
export class DetalleColaboradorComponent implements OnInit {
  ...
  constructor(private reportesService: ReporteColaboradoresService,
  ...
  ngOnInit(): void {
    ...
    this.fechaInicio = this.detalleColaborador.tiempoInicio

    this.fechaFin = this.detalleColaborador.tiempoFin

    this.listaProyectos();

    this.abreProyecto(this.detalleColaborador.idColaborador, this.detalleColaborador.nombreProyecto)
    
    this.avatarColab = `background-image: url(../../../../assets/images/avatar_${this.detalleColaborador.idColaborador}.jpg);`;
  }
  ...
  listaProyectos() {
    ...
    this.reportesService.getActividadesColaboradores_byTime(this.fechaInicio.getTime(), this.fechaFin.getTime())
      .subscribe((proyectos: any) => {
        console.log("proyectoos colab", this.detalleColaborador.idColaborador);

        proyectos.newData.forEach((element: any) => { //recorre la lista de los proyectos por cliente
          if (element._id == this.detalleColaborador.idColaborador) { //encuentra la coincidencia del cliente
  ...
  abreProyecto(idColaborador: string, nombreColaborador: string) {
    
    this.reportesService.getActividadesColaborador_byTime(idColaborador, this.fechaInicio.getTime(), this.fechaFin.getTime())
      .subscribe((actividades: any) => {
        console.log('actividadesColaborador', actividades);
        ...
        this.colaboradorActual.nombre = nombreColaborador;
        this.colaboradorActual.tiempo = this.sumaTiempos(arrayTime);
        this.horasFacturables = this.sumaTiempos(arrayTimeFact);
        this.colaboradorActual.id = idColaborador;
  ...
  formatCliente(arrayClientes: any) {
    arrayClientes.data.forEach((element: any) => {
      ...
      if (element._id == this.detalleColaborador.idCliente) {
  ...
  filtrarTiempo() {
    ...
    this.abreProyecto(this.detalleColaborador.idProyecto, this.detalleColaborador.nombreProyecto)
  ...
  abrirProyecto(idProyecto: string, nombreProyecto: string, horas: any) {
    ...
    this.detalleColaborador.nombreProyecto = nombreProyecto
    this.detalleColaborador._id = idProyecto
    this.detalleColaborador.horas = horas
    ...
    this.reportesService.getActividadesProyecto_byTime(idProyecto, this.detalleColaborador.fechaInicio.getTime(), this.detalleColaborador.fechaFin.getTime())
